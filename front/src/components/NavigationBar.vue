<template>
    <div class="w-full dark:bg-blue-500">
        <div class="w-3/4 container flex justify-between items-center mx-auto">
            <div class="">
                <div class="cursor-pointer" @click="toggleDarkMode">
                    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 20 20" height="48px" viewBox="0 0 20 20" width="48px" fill="#000000" v-if="!this.darkMode">
            ...
            <div class="logo text-yellow-300 font-bold text-4xl py-4">
                Datarc
            </div>
            <div class="">
                <ul class="flex flex-row mt-4 md:mt-0">
                    <li>
