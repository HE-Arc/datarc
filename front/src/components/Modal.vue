<template>
	<Transition name="fade">
		<div
			class="ez modal fixed w-full h-full top-0 left-0 flex items-center justify-center text-black z-30"
			v-if="isShow"
		>
			<div
			...
			<div
				class="modal-container bg-white w-11/12 md:max-w-md lg:max-w-lg mx-auto rounded shadow-lg z-50 overflow-y-auto"
			>
				<div
